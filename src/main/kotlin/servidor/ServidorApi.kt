    ...
    get("/") {
        call.respondHtml {
            body {
                ...
                ul {
                    ol { +"POST - /usuario                      - Cadastrar um usuário"}
                    ol { +"GET  - /usuario/ativo                - Consultar usuário ativo"}
                    ol { +"POST - /login                        - Efetuar login com email e senha"}
                    ol { +"POST - /commoditie/combustivel/local - Cadastrar Local do Combustivel"}
                    ol { +"POST - /commoditie/combustivel       - Cadastrar Preço de Combustível" }
                    ol { +"GET  - /precos/media                 - Consultar Preço Médio por Estado"}
                    ol { +"GET  - /precos/menor                 - Consultar Menor Preço no Muncípio"}
...
fun Route.login() {
    post("/login") {
        ...
        call.respond(HttpStatusCode.OK, "Login efetuado com sucesso.")
    }
}
